...
Usage:
    ...
    $ python path/to/train.py --data coco128.yaml --weights '' --cfg yolov5s-CBAM.yaml --img 640  # from scratch
"""
...
def parse_opt(known=False):
    ...
    parser.add_argument('--cfg', type=str, default='models\Mymodels\yolov5s-CBAM.yaml', help='model.yaml path')
